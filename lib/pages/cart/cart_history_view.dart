          ...
          child: Container(
            ...
            child: cartHistoryList.isNotEmpty
                ? ListView(children: [
                    ...
                    //     child: ,
                    //   )
                    for (var time in Get.find<CartController>()
                        .getCountItemsPerOrderTime()
                        .keys)
                      Container(
                ...
                : SizedBox(
                    ...
                    child: const EmptyPageView(
                      text: "You have no orders in your history list",
